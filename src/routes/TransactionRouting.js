...
const { addLoanApplication, getLoanApplications, cancelLoanApplication, getLoanRemark, getCustomerRemark, addLoanDocument, getLoanDocumentsByLoanId, getLoanApplicationById, updateLoanApplication, getAppraisalNote, approveLoanApplication, searchLoanApplications, getLoanApplicationByIdForRepayment, } = require("../controller/TransactionsController");
...
router.get("/goldloan/getLoanRepayment/:id", getLoanApplicationByIdForRepayment);
