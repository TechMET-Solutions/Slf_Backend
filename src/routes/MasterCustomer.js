...
const { addCustomer, getCustomers, updateCustomer, blockUnblockCustomer, searchCustomers, getCustomersBySearch,  } = require("../controller/MastercustDocument");
...
Customer_router.get("/searchCustomers",getCustomersBySearch);
